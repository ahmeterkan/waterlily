    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ThirdLevel.this, ThirdLevel.class);
        ...
        nxtLVL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ThirdLevel.this, FourthLevel.class);
                startActivity(intent);
            }
        });
            ...
            public void onFinish() {
                ...
                new CountDownTimer(60000, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        if (yildiz > preferences.getInt("lvl3", 0)) {
                            editor.putInt("lvl3", yildiz);
